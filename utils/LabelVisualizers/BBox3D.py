...
def visualize_3d_bounding_boxes(raw_data_dir, output_path):
    visualized_data_dir = os.path.join(output_path, "3DBBs & Keypoints")
...
def main():
    ...
    visualize_3d_bounding_boxes(raw_data_dir, output_path)
